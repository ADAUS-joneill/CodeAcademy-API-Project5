...
const numberMenMedalists = country => {
    return "SELECT count(*) from GoldMedal where country = '" + country + "'" + " AND gender = 'Men'";
};
...
const numberWomenMedalists = country => {
    return "SELECT count(*) from GoldMedal where country = '" + country + "'" + " AND gender = 'Women'";
};
...
const orderedMedals = (country, field, sortAscending) => {
    return "SELECT * FROM GoldMedal WHERE country ='" + country + "'" + (typeof field !== "undefined" ? " ORDER BY " + field : "") + (typeof sortAscending !== "undefined" ? " ASC" : "");
};
